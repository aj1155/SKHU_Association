    ...
    function html5Upload() {	
    	var tempFile,
    		sUploadURL;
    	sUploadURL= '/image/file_uploader_html5'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/image/file_uploader',	//샘플 URL입니다.
 	        sCallback : 'resources/editor/sample/photo_upload/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
